  ...
  Future<CourseSheet> getCourseSheet({required String courseId}) async {
    ...
    return const CourseSheet(
      columns: [
        SheetColumn(
          id: 'item-1',
          objectId: 'quiz-uuid-0001',
          title: 'Квиз: Алгебра',
        ),
        SheetColumn(
          id: 'item-2',
          objectId: 'quiz-uuid-0002',
          title: 'Квиз: Геометрия',
        ),
        SheetColumn(
          id: 'item-3',
          objectId: 'quiz-uuid-0003',
          title: 'Контрольная №1',
        ),
        SheetColumn(
          id: 'item-4',
          objectId: 'quiz-uuid-0004',
          title: 'Квиз: Вероятности',
        ),
        SheetColumn(
          id: 'item-5',
          objectId: 'quiz-uuid-0005',
          title: 'Итоговый тест',
        ),
      ],
      rows: [
        SheetRow(
          ...
          scores: [
            SheetScore(itemId: 'item-1', score: 8.5),
            SheetScore(itemId: 'item-2', score: 7.2),
            SheetScore(itemId: 'item-3'),
            SheetScore(itemId: 'item-4', score: 9.1),
            SheetScore(itemId: 'item-5', score: 6.0),
          ],
        ),
        SheetRow(
          studentId: 'stud-2',
          ...
          scores: [
            SheetScore(itemId: 'item-1', score: 9.2),
            SheetScore(itemId: 'item-2'),
            SheetScore(itemId: 'item-3', score: 6.0),
            SheetScore(itemId: 'item-4', score: 4.5),
        ...
        SheetRow(
          ...
          scores: [
            ...
            SheetScore(itemId: 'item-2', score: 5.5),
            SheetScore(itemId: 'item-3', score: 8.8),
            SheetScore(itemId: 'item-4'),
            SheetScore(itemId: 'item-5', score: 7.7),
          ],
        ),
        SheetRow(
          studentId: 'stud-4',
          ...
          scores: [
            SheetScore(itemId: 'item-1', score: 10.0),
            SheetScore(itemId: 'item-2', score: 9.5),
            SheetScore(itemId: 'item-3', score: 8.2),
            SheetScore(itemId: 'item-4', score: 7.8),
            SheetScore(itemId: 'item-5', score: 9.0),
          ],
        ),
      ],
    );
