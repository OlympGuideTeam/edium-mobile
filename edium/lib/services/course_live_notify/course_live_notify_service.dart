...
/// Подключается к /riddler/v1/courses/live/ws и нотифицирует об открытых лобби.
///
/// Вызови [connect] с course_ids — получишь актуальный список через [items].
/// При разрыве — реконнект не встроен, вызывай снаружи.
class CourseLiveNotifyService {
  WebSocket? _socket;
  StreamSubscription? _sub;

  final _controller = StreamController<List<CourseLiveItem>>.broadcast();
  final _items = <String, CourseLiveItem>{}; // sessionId → item
